...
moi2.profession = 'Web Developer';
moi2.etatcivil = 'marié'

console.log(`Je m'appelle ${moi2.nom} ${moi2.prenom}, j'ai ${moi2.age} ans, je suis ${moi2.profession} et je suis ${moi2.nationalite}, et je suis ${moi2.etatcivil}`);*/
...
const stylo={
    ...
    marque: 'bic',
    description() {
        return `J'écris avec un stylo ${this.type} ${this.couleur} de marque ${this.marque}`;
    },
};

stylo.couleur = 'rouge';
console.log(stylo.description());
